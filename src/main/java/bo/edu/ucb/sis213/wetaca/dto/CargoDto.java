...
public class CargoDto {
    ...
    public CargoDto(Integer id_cargo, String descripcion_cargo, Integer id_wtc_usuario) {
    ...
    public String toString() {
        return "CargoDto{" + "id_cargo=" + id_cargo + ", descripcion_cargo=" + descripcion_cargo + ", id_wtc_usuario=" + id_wtc_usuario + '}';
    }
